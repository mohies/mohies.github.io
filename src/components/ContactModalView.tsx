  ...
  return (
    <div className="contact-modal">
      ...
      <motion.div
        ...
        className="card contact-modal__panel"
      >
        <div className="contact-modal__header">
          ...
          <div>
            <h3 className="contact-modal__title">{modalText.title}</h3>
            <p className="contact-modal__subtitle">{modalText.subtitle}</p>
          </div>
        </div>
        ...
        >
          ...
          />
          <textarea
            className="contact-modal__input contact-modal__input--textarea"
            placeholder={modalText.message}
            rows={5}
            value={mensaje}
          ...
          <div className="contact-modal__actions">
            <button type="button" onClick={onClose} className="contact-modal__button contact-modal__button--ghost">
              {modalText.cancel}
            </button>
            <button type="submit" className="contact-modal__button contact-modal__button--primary" disabled={loading}>
              {loading ? modalText.sending : modalText.send}
            </button>
          </div>
        </form>
      </motion.div>
